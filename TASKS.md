...
- [ ] Мобильная навигация: бургер ведёт на menu.html, ссылки на Stories в мобильном хедере нет
      (только в футере). Досталось от старой вёрстки — стоит сделать нормальное меню
