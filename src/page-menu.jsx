...
window.mountSitePage("menu", ({ lang, scrapbook }) => (
  <>
    <window.PageHero
      ...
      sub="Specialty coffee, pizza, fresh pasta and all-day breakfast. Dine in, take away, or order for delivery."
    />
    ...
    <window.ProseSection
      ...
      paras={[
        "Signa is an all-day kitchen in Nusa Dua. Mornings start with specialty coffee, syrniki and big breakfasts; afternoons bring pizza on Italian flour and house-made pasta; evenings settle into shared plates and Bali cocktails.",
