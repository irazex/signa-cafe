...
# Costs are shown through the authenticated admin endpoint, and the admin JSX
# contains the human-readable labels for the new transcreation stages. Keep all
# three files atomic from the operator's point of view.
up data/story-costs.json
up src/admin.jsx
